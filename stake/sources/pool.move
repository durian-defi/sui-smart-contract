module pool::pool {
  ...
  const ERROR_AMOUNT_CANNOT_BE_ZERO: u64 = 3;
    ...
    transfer::public_transfer(coins, storage.wallet);
  ...
  public entry fun transfer_ownership(admin_cap: PoolAdminCap, new_owner: address){
    transfer::transfer(admin_cap, new_owner)
  }

  public entry fun update_wallet(_: &mut PoolAdminCap, storage: &mut PoolStorage, new_wallet: address){
